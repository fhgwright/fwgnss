"""Module for parsing (Skeleton) NMEA and binary messages."""
...
# Skeleton NMEA additions

class NmeaParser(nmea.NmeaParser):
  """Class for Skeleton NMEA parser (adds vendor sentences)."""
...
class NmeaDecoder(nmea.NmeaDecoder):
  """Skeleton added NMEA sentence decoder."""
  DECODER_DICT = {}


# Skeleton binary messages


class Message(binary.BinaryDataItem):
  """Generic Skeleton binary message item from extracter."""
  ENDIANNESS = 'little' or 'big' # *** Define this properly ***
  ...
  def Extract(cls, extracter):  # pylint: disable=too-many-return-statements
    """Extract a Skeleton binary item from the input stream."""
    # Not implemented yet.
    _ = extracter
    return None, 0
...
class BinaryDecoder(binary.Decoder):
  """Skeleton binary message decoder."""
  DECODER_DICT = {}
